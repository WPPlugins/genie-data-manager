...
include_once dirname(dirname(__FILE__)) . '/Logic/genie_DataBase.php';
  ...
  class genie_MailChimp
  {
        public function AddMail($email,$mailChimpAPI,$mailChimpListId,$submit_url)
        {
           
           $MailChimp = new DM_Internal_MailChimp($mailChimpAPI);
           $result = $MailChimp->call('lists/subscribe', array(
                'id'                => $mailChimpListId,
                'email'             => array('email'=>$email),
                'merge_vars'        => array('FNAME'=>'None', 'LNAME'=>'None'),
                'double_optin'      => true,
                'update_existing'   => true,
                'replace_interests' => false,
                'send_welcome'      => false,
            ));
           // echo "MailChimp:".json_encode($result);
        }
  }
